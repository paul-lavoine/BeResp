...
class ShopsController: NSObject {
    ...
    func getShops() -> [Shop] {
        return [
            ...
            Shop(with: "Le comptoir d'Edgar", category: .epicerie, image: "marche_bio", openningTime: "10:00-19:00", information: "", price:.cheap, rate: 4.6, commentsCount: 16),
            Shop(with: "Biocool", category: .bio, image: "marche_bio", openningTime: "8:30-19:00", information: "", price:.medium, rate: 4.0, commentsCount: 5),
