...
class ShopsController: NSObject {
    ...
    var shops: [Shop] = [
        ...
        Shop(with: "Le comptoir d'Edgar", category: .epicerie, image: "marche_bio", openningTime: "10:00-19:00", information: "", price:.cheap, rate: 4.3, commentsCount: 16, distance: 2.5),
        Shop(with: "Biocool", category: .bio, image: "marche_bio", openningTime: "8:30-19:00", information: "", price:.medium, rate: 3.0, commentsCount: 5, distance: 3),
        Shop(with: "Le marché de nos villes", category: .marche, image: "marche_bio", openningTime: "9:00-18:00", information: "", price:.expensive, rate: 4.5, commentsCount: 64, distance: 3.2)
    ]
